...
export default function PaymentPage() {
  ...
  const handleFindRider = () => {
    ...
    // Navigate to finding rider page after a brief delay
    setTimeout(() => {
    ...
    <div className="flex flex-col h-screen bg-white">
      ...
      <div className="flex-1 p-6 bg-white">
        ...
        <button
          ...
          disabled={isLoading}
          className={`w-full py-4 rounded-lg font-medium focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 ${
            isLoading ? 'bg-blue-400 text-white cursor-not-allowed' : 'bg-blue-600 text-white hover:bg-blue-700 transition-colors'
          }`}
        >
          {isLoading ? (
